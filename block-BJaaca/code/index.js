...
character.greet = function(name, title) {
    alert(`I am ${name} and my title is ${title}`);
}
...
character.isAdult = function(age) {
...
character.changeIsAdult = function(age) {
    if (isAdult(age) === true) return false;
    if (isAdult(age) === false) return true;
}
